    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li<?php if(!isset($_GET['page']) || !in_array($_GET['page'],array("itemscan","database","banlist","chatlog"))){echo ' class="active"';} ?>><a href="?">Home</a></li>
        ...
        <div class="container mainContent">
            <div class="content">
                ...
                ?>
                <!-- END PAGE CONTENT -->
				<p>Access restrictions: ItemScan (Moderator), DB Tools (Helpdesk), BanList (Helpdesk), KillLog (Helpdesk), ChatLog (Helpdesk), DB Backups (Server Admin)</p>
            </div>
        </div>
