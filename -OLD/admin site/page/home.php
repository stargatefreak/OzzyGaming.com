...
?>
    ...
    <ul>
        ...
        <li>All current features have caching (6hr frontpage stats, 30min banlist, 5min killlog, 5min db tools) to reduce server load</li>
        <li></li>
        ...
        <li>Chat log is waiting for our chat logging to be resolved</li>
    </ul>
<?php
